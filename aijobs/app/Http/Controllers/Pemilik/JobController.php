...
class JobController extends Controller
{
    public function index(Request $request)
    {
        ...
        $job2 = Job::where('owner_id', '=', $user_id)->where('job_status','!=','3')->get();
        return view('pemilik.lowongan.index')->with('job', $job2);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pemilik.lowongan.create')->with('category',$category);
    }
    ...
    public function edit($id)
    {
        ...
        $job = Job::find($id);
        return view('pemilik.lowongan.edit')->with('category',$category)->with('job',$job);
    }
