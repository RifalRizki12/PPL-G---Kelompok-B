...
<head>
    ...
    <title>AI.Jobs || Verifikasi Pemilik Usaha</title>
...
<body>
    ...
    <div class="section">
        <div class="container">
            <h3>Verifikasi Pemilik Usaha</h3>
            <div class="box">
                <table border="1" cellspacing="0" class="table" style="color: #fff;">
                    ...
                    <tbody>
                        <?php
                            $no = 1;
                            $verifikasi = mysqli_query($conn, "SELECT * FROM owners WHERE owner_ver = 0 ORDER BY owner_id DESC");
                        ...
                        <tr>
                            ...
                            <td align="center" width = "150px">
                                <a href="proses_verifikasi.php?idpu=<?php echo $row['owner_id'] ?>" onclick="return confirm ('Verifikasi Akun ini?')">Verifikasi</a> || <a href="hapus_usaha.php?idpu=<?php echo $row['owner_id'] ?>" onclick="return confirm ('Anda akan menghapus akun tersebut')">Hapus</a>
                            </td>
                        </tr>
                        <?php }}else { ?>
                            <tr>
