            ...
            <div class="box">
                <table border="1" cellspacing="0" class="table" style="color: #fff;">
                    ...
                    <tbody>
                        <?php
                            $no = 1;
                            $verifikasi = mysqli_query($conn, "SELECT * FROM users WHERE user_ver = 1 ORDER BY id DESC");
                        ...
                        <tr>
                            ...
                            <td align="center" width = "150px">
                                <a href="edit_profiluser.php?idpk=<?php echo $row['id'] ?>" >Edit</a> || <a href="hapus_usaha.php?idpk=<?php echo $row['id'] ?>" onclick="return confirm ('Anda akan menghapus akun tersebut')">Hapus</a>
                            </td>
                        </tr>
                        <?php }}else { ?>
                            <tr>
